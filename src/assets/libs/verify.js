...
;(function($, window, document,undefined) {
    ...
    Slide.prototype = {
        ...
        loadDom : function() {
        	...
        	if(this.options.mode == 'pop') {
        		this.htmlDoms.out_panel.css({'display': 'none', 'position': 'absolute', 'top': '42px'});
        ...
        start: function(e) {
        	if(this.isEnd == false) {
	        	...
	        	this.htmlDoms.move_block.css('background-color', 'rgb(11,195,147)');
	        	this.htmlDoms.left_bar.css('border-color', 'rgb(11,195,147)');
